...
public class PivotEntity {
	...
	public static void dataForCarousels(Object entity, String header, HashMap<String, String> subjectColumn,
		...
		if (entity != null) {
			...
			// String data[] = {entity.toString(), String.join(":::", factList1),
			// String.join(":::", factList2),
	...
	public static void main(String args[]) {
		...
		try {
			 ...
			 * File(".//dataForDownwardC_1.csv"); File file2 = new
			 * File(".//dataForSidewardC_1.csv");
			 * 
			...
			while (rowIterator.hasNext()) {
				...
				StringBuffer pivotEntityForDownward = entityForDownwardCarousel(context.toString().split(":::"),
						queryMap);
				// System.out.println("Downward Carousel Pivot Entity ----
				// "+pivotEntityForDownward);
			 ...
			 * "ISO-8859-1")); reader1 =
			 * Files.newBufferedReader(Paths.get(".//subjectAndFact_2.csv"),Charset.forName(
			 * "ISO-8859-1")); CSVParser csvParser = new CSVParser(reader,
			 * CSVFormat.DEFAULT); CSVParser csvParser1 = new CSVParser(reader1,
			 * CSVFormat.DEFAULT);
			 * 
			 * HashMap<String,String> subjectColumn = new HashMap<String,String>();
			 * HashMap<String,String> factsColumn = new HashMap<String,String>();
			 ...
			 * continue; String[] contexts = csvRecord.get(2).split(":::"); String[] queries
			 * = csvRecord.get(3).split(":::");
			 * 
			 * HashMap<String,String> queryMap = new HashMap<String,String>();
			 * 
			 ...
			 * 
			 * queryMap.put(query.substring(0, index), query.substring(index+3)); }
			 * //System.out.println(contexts); //System.out.println("==========");
			 * //System.out.println(queryMap.keySet());
			 * 
			 * StringBuffer pivotEntityForDownward = entityForDownwardCarousel(contexts,
			 * queryMap); //System.out.println("Downward Carousel Pivot Entity ---- "
			 * +pivotEntityForDownward); String pivotEntityForSideway =
			 * pivotEntityForSideways(subjectColumn, csvRecord.get(0), csvRecord.get(1));
			 * //System.out.println("Sideward Carousel Pivot Entity ---- "
			 * +pivotEntityForSideway); dataForCarousels(pivotEntityForDownward,
			 * csvRecord.get(0), subjectColumn, factsColumn, csvRecord.get(1), writer1,
			 * csvRecord.get(2), csvRecord.get(3)); dataForCarousels(pivotEntityForSideway,
			 * csvRecord.get(0), subjectColumn, factsColumn, csvRecord.get(1), writer2,
			 * csvRecord.get(2), csvRecord.get(3)); } writer1.close(); writer2.close();
			 */
		} catch (IOException e) {
			e.printStackTrace();
		}
